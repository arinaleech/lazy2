...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', 'PRIME_USER').split()]
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Lazy') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Lazy') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Lazy') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Lay')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "comming soon...") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '72a7f0131e')
...
HTTP_PROXY = environ.get("HTTP_PROXY", "0")
OUO_IO_API_KEY = ""
...
DOWNLOAD_TEXT_URL = "comming soon..."

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "comming soon..."
